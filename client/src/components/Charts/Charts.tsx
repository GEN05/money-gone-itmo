...
const Charts: FC = () => {
    ...
    const isAnyTransaction = store.user.transactions.length > 0 || store.user.transactionsFromBank.length > 0;
            ...
            <div className='chart-line-sizer'>
                ...
                <div className='chart-line'>
                    <div className='chart-line-wrapper '>
                        {isAnyTransaction ? <ChartLine/> : <div className="empty-chart">Waiting for transactions</div>}
                    </div>
                </div>
            </div>
            <hr/>
            <div className='chart-doughnut-sizer'>
                ...
                <div className='chart-doughnut'>
                    <div className='chart-doughnut-wrapper'>
                        {isAnyTransaction ? <ChartDoughnut/> : <span className="empty-chart">Waiting for transactions</span>}
                    </div>
                </div>
            </div>
        </div>
